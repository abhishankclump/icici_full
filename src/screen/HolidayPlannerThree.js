  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
            ...
            source={require('../../assets/img/savingsBro.png')}
          />
      ...
      <View style={{marginHorizontal:50,marginTop:20}}>
        <Text style={{fontSize:16,color:'black',fontWeight:'bold'}}>How much would your holiday cost you</Text>
        <Text style={{fontSize:16,color:'black',fontWeight:'bold'}}>today</Text>

      </View>
      <View style={{borderColor:'orange',borderRadius:30,borderWidth:1,marginHorizontal:40,marginTop:10,width:"75%"}}>
      <TextInput 
     ...
     <View style={{flexDirection:'row',marginHorizontal:30,marginLeft:25,marginTop:20}}>
                           <View style={{width:'50%',marginRight:10}}>
                            ...
                            <TouchableOpacity onPress={()=> navigation.navigate('HolidayPlannerFour')}
