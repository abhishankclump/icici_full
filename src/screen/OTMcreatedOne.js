...
const Card = ({navigation}) => {
    ...
    return (
      ...
      {/* <Header title="Holiday Planner" /> */}
            ...
            <View style={{borderRadius:12,borderColor:'#C0C0C0',borderWidth:1,padding:20,marginTop:20}}>
               <View style={{flexDirection:'row'}}>
                ...
                <View>
                    ...
                    <Text style={{fontSize:16,color:'#f94279',fontWeight:'bold',marginTop:5}}>OTM limit: ₹10,000</Text>
            ...
            <View style={{borderRadius:12,borderColor:'#C0C0C0',borderWidth:1,padding:20,marginTop:20,marginBottom:20}}>
               <View style={{flexDirection:'row'}}>
                <View style={{}}>
                <Text  onPress={()=> navigation.navigate('OTMcreatedTwo')} style={{fontSize:16,color:'black',fontWeight:'500'}}>
