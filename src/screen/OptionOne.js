...
<View style={{ marginHorizontal: 10 }}>
    <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'black' }}>Select Frequency </Text>
...
<View>
    ...
    <Text onPress={()=> navigation.navigate('MainScreen')} style={{ marginLeft: 10, fontSize: 16, color: '#C0C0C0', fontWeight: 'bold',textAlign:'center',paddingHorizontal:10 }}>5%</Text>
    ...
    <Text style={{ marginLeft: 10, fontSize: 16, color: '#C0C0C0', fontWeight: 'bold',textAlign:'center' }}>Custom</Text>
