                    ...
                    <View
                        ...
                        <View
                            style={{
                                ...
                                <View style={{ justifyContent: 'center', padding:10,alignItems:'center',marginTop:-15 }}>
                            <Icon name='checkcircle' size={30} color={'limegreen'}></Icon>
                            ...
                            <View style={{ marginTop: 20 }}>
                                    ...
                                    <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', textAlign:'center' }}>Thank you!</Text>
                                ...
                                <Text style={{ textAlign: 'center', color: '#C0C0C0', fontSize: 12, fontWeight: '400', marginTop: 5 }}>ID: 123456788 | 12-03-2021.09.30AM | ARN-00201</Text>
                                    ...
                                    <View style={{ flexDirection: 'row',marginTop:20 }}>
                                        ...
                                        <Text style={{ marginLeft:30, fontSize: 14, color: '#C0C0C0', fontWeight: 'bold' }}> Scheme</Text>
                                    ...
                                    <View style={{flexDirection:'row',marginTop:10}}>
                                        <Text style={{marginLeft:30,color:'black',fontWeight:'bold',fontSize:16}}>Balanced Advantage Fund</Text>
                                        <Text style={{marginLeft:90,color:'black',fontWeight:'bold',fontSize:16}}>₹10,000</Text>
                                    ...
                                    <View style={{flexDirection:'row',marginTop:50}}>
                                        <Text style={{fontSize:16,fontWeight:'bold',color:'black',marginLeft:30}}>Total</Text>
                                        <Text style={{fontSize:16,fontWeight:'bold',color:'black',marginLeft:240}}>20,000</Text>
                                    </View>
                                ...
                                <View style={{flexDirection:'row',marginHorizontal:50,marginTop:30}}>
                                    ...
                                    <Text style={{fontSize:14,color:'darkorange',fontWeight:'bold'}}>View Here</Text>
                                </View>

                            
                                <View style={{borderRadius:30,padding:15,marginHorizontal:20,backgroundColor:'darkorange',marginTop:20}}>
                                    <Text  onPress={()=>navigation.navigate("SecondTime")} style={{textAlign:'center',color:'white',fontWeight:'bold',fontSize:14}}>Okay</Text>
                                </View>
