...
import ThankyouOTM from "./ThankyouOTM"
const Card = ({navigation}) => {
    ...
    return (
      ...
      <View style={{marginHorizontal:40,marginTop:20}}>
          ...
          <Text style={{fontSize:18,color:'black',fontWeight:'bold',marginTop:30}}>Bank Account</Text>
      ...
      <View style={{ alignItems: 'flex-start', marginHorizontal: 30, flexDirection: 'row',borderRadius:20,elevation:20,backgroundColor:'white',padding:20,marginTop:20,marginBottom:20 }}>
                        ...
                        <View style={{ alignItems: 'flex-start', marginHorizontal: 30,borderRadius:20,elevation:20,backgroundColor:'white',padding:20,marginTop:20,marginBottom:20 }}>
                            ...
                            <Text onPress={()=> navigation.navigate('')} style={{ fontWeight: 'bold', color: 'black', fontSize: 18 }}>Monthly (SIP)</Text>
                            ...
                            <Text onPress={()=> navigation.navigate('')} style={{ fontSize:24, color: 'black', fontWeight: '600',marginBottom:20 }}>₹30,000</Text>
                        </View>
                        ...
                        <View style={{ alignItems: 'flex-start', marginHorizontal: 30,borderRadius:20,elevation:20,backgroundColor:'white',padding:20,marginTop:10,marginBottom:20 }}>
                            ...
                            <Text onPress={() => { setShow(true)  }}style={{ fontWeight: 'bold', color: 'black', fontSize: 18 }}>One Time(Lumpsum)</Text>
                            <View style={{flexDirection:'row'}}>
                            ...
                            <Text style={{ fontSize:24, color: 'black', fontWeight: '600',marginBottom:20 }}>₹10,000</Text>
                            </TouchableOpacity>
                        </View>
                            ...
                            <ThankyouOTM visible={show} closeCallback={() => {setShow(false) }}/>
...
const Foliolist = ({navigation}) => {
    ...
    return ( <>
        ...
        {/* <Thankyoupopup visible={popup} closeCallback={() => setPopup(false)}/> */}
   </> ); 
}
