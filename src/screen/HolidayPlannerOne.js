...
export default function HolidayPlannerOne({navigation}) {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={{marginHorizontal:30,alignContent:'center',alignItems:'center',marginTop:20}}>
      <Image
            
            source={require('../../assets/img/journeyAmico.png')}
          />
      ...
      <View style={{marginHorizontal:50,marginTop:50}}>
        <Text style={{fontSize:16,color:'black',fontWeight:'bold'}}>Name of the goal?</Text>
      </View>
      <View style={{borderColor:'orange',borderRadius:30,borderWidth:1,marginHorizontal:50,marginTop:20,paddingHorizontal:10}}>
      <TextInput style={{marginLeft:10,fontSize:16}}> Raj personal trip </TextInput>
      </View>
     ...
     <View style={{flexDirection:'row',marginHorizontal:30,marginLeft:25,marginTop:20}}>
                           <View style={{width:'50%',marginRight:10}}>
                            ...
                            <TouchableOpacity onPress={()=> navigation.navigate('HolidayPlannerTwo')}
