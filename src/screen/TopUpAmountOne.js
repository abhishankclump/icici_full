...
const GoalSavedSuccesfully = ({ visible, closeCallback, shareOptionCallback }) => {
                    ...
                    <View
                        ...
                        <View
                            ...
                            <View style={{ marginTop: 20 }}>
                                ...
                                <TextInput  style={{  color: 'black ', fontSize:15, fontWeight: '500', marginTop: 5,marginRight:80,marginLeft:20}}>₹ 10,000 </TextInput>
                                </View>
...
<View style={{flexDirection:'row',marginTop:20,marginHorizontal:20}}>
    <Text style={{  color: 'black', fontSize:18, fontWeight: 'bold',marginHorizontal:30}}>Do you want to set a Cap</Text>
...
<View style={{flexDirection:'row',justifyContent:'center',marginTop:30}}>
                                ...
                                <View style={{flexDirection:'row',justifyContent:'center',marginTop:30}}>
                                <View style={{borderColor:'#C0C0C0',borderWidth:1,borderRadius:30}}>
                                <TextInput  style={{  color: 'black ', fontSize:15, fontWeight: '500', marginTop: 5,marginRight:50,marginLeft:20}}>₹ 10,000 </TextInput>
                                </View>
