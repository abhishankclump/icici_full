...
const Card = ({navigation}) => {
        ...
        <>
            <View style={{height:Dimensions.get('window').height}}>
                <ScrollView style={{height:'100%', paddingBottom:100}}>
                    ...
                    <View style={{ margin: 20, paddingHorizontal: 10, paddingVertical: 20, borderWidth: 0, elevation: 20, backgroundColor: 'white', borderRadius: 20, height: '26%' }}>
                        ...
                        <View style={{ borderRadius: 20, borderWidth: 1, borderColor: '#C0C0C0', justifyContent: 'center', paddingBottom: 30, marginTop: 20 }}>
                        ...
                        <View style={{borderRadius:12,borderColor:'#C0C0C0',borderWidth:1,padding:20,marginTop:20,height:'auto'}}>

                            <View style={{ flexDirection: 'row', marginHorizontal:10 }}>
                                <Text style={{ fontSize: 16, fontWeight: 'bold', color: 'black', marginTop: 10 }}>Create New Autopay Mandate</Text>
                            ...
                            <View style={{ marginTop:5, marginHorizontal:10 }}>
                                <Text style={{ fontWeight: 'bold', color: '#C0C0C0', fontSize:14 }}>{word}</Text>
 ...
 <View style={{ margin: 20, paddingHorizontal: 10, paddingVertical: 20, borderWidth: 0, elevation: 20, backgroundColor: 'white', borderRadius: 20, height:'auto', justifyContent: 'center' }}>
...
<View style={{ alignItems: 'flex-start', marginHorizontal:10 }}>
    ...
    <Text  onPress={()=> navigation.navigate('FirstTime')} style={{ fontWeight: 'bold', color: 'black', fontSize: 16 }}>{heading}</Text>
</View>

<View style={{marginHorizontal:5,marginTop:20,flexDirection:'row',borderRadius:20,borderColor:'#C0C0C0',borderWidth:1,padding:20}}>

<Text style={{color:'black'}}>{last}</Text>
<View style={{ marginLeft: 30, marginBottom: 20 }}>
                                    <RadioButton
                                        value="first"
                                        status={checked === 'first' ? 'checked' : 'unchecked'}
