...
import BillerRegistration from "./BillerRegistration"
...
const Card = ({navigation}) => {
    ...
    return (
      ...
      <View style={{marginHorizontal:40,marginTop:20}}>
          <Text style={{fontSize:16,color:'black',fontWeight:'bold',}}>You have select payment method as biller</Text>
          <Text style={{fontSize:16,color:'black',fontWeight:'bold',}}>for your dream house Investment</Text>
          <Text style={{fontSize:18,color:'black',fontWeight:'bold',marginTop:20}}>Bank Account</Text>
      ...
      <View style={{ alignItems: 'flex-start', marginHorizontal: 30, flexDirection: 'row',borderRadius:20,elevation:20,backgroundColor:'white',padding:20,marginTop:20,marginBottom:20 }}>
                        ...
                        <View style={{marginHorizontal:30,flexDirection:'row',marginTop:10}}>
                            <Text style={{color:'#C0C0C0',fontSize:14}}>AJDB12N123</Text>
                            <View style={styles.verticalline}></View>
                            <Text style={{marginLeft:10,color:'#C0C0C0',fontSize:14}}>Folio: 123456789</Text>
                        ...
                        <View style={{ alignItems: 'flex-start', marginHorizontal: 30,borderRadius:20,elevation:20,backgroundColor:'white',padding:20,marginTop:20,marginBottom:20 }}>
                            ...
                            <Text onPress={() => { setShow(true)  }}  style={{ fontSize: 14, color: 'darkorange', fontWeight: 'bold' }}>Pay</Text>
                            ...
                            <Text  style={{ fontSize: 24, color: 'black', fontWeight: '600',marginBottom:20 }}>₹30,000</Text>
                        </View>
                        ...
                        <View style={{ alignItems: 'flex-start', marginHorizontal: 30,borderRadius:20,elevation:20,backgroundColor:'white',padding:20,marginTop:10,marginBottom:20 }}>
                            ...
                            <View style={{flexDirection:'row'}}>
                                ...
                                <View style={{ borderRadius:20, borderColor: 'darkorange', borderWidth: 1, justifyContent: 'center', padding:10,marginLeft:130,paddingHorizontal:30 }}>
                            <Text onPress={() => { setPopup(true)  }} style={{ fontSize: 14, color: 'darkorange', fontWeight: 'bold'}}>Pay</Text>
                            ...
                            <Text onPress={()=> navigation.navigate('SecondTime')} style={{ fontSize: 24, color: 'black', fontWeight: '600',marginBottom:20 }}>₹10,000</Text>
                        </View>
                            ...
                            <OneTime visible={popup} closeCallback={() => {setPopup(false) }} navigation={navigation}/>
                            <BillerRegistration visible={show} closeCallback={() => {setShow(false) }} navigation={navigation}/>
