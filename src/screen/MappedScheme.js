    ...
    return (
        ...
        <View> 
          ...
          />
               ...
               <Text style={{fontSize:16, marginTop:20,textAlign:'center'}}>{sen}</Text>
               <Text style={{fontSize:16,marginLeft:20}}>of your goal will be</Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                    <View>
                        ...
                        <TouchableOpacity>
                        <Text style={{color:'darkorange',fontWeight:'bold',fontSize:12,marginLeft:60,marginTop:8}}>Edit</Text>
                        </TouchableOpacity>
                    ...
                    <View>
                        ...
                        <TouchableOpacity>
                        <Text style={{color:'darkorange',fontWeight:'bold',fontSize:12,marginLeft:40,marginTop:8}}>Edit</Text>
                        </TouchableOpacity>
                        </View>
            ...
            <View style={{ paddingHorizontal: 20, paddingVertical: 20, borderWidth: 0, elevation: 20, backgroundColor: 'white', borderRadius: 20,flexDirection:'row',marginHorizontal:20}}>
              ...
              <Text style={{fontSize:16,fontWeight:'bold',color:'black'}}>Mapped scheme</Text>
              
              <View style={{borderRadius:100,alignItems:'center',marginLeft:10,width:20,height:20,backgroundColor:'#D3D3D3'}}>
              <Text style={{textAlign:'center',color:'black',fontWeight:'400'}}>3</Text>
              </View>
              <View style={{marginLeft:120}}>
                <TouchableOpacity>
              <Text style={{fontSize:14,fontWeight:'bold',color:'darkorange'}}>Edit</Text>
              </TouchableOpacity>
              </View>
            ...
            <View style={{marginHorizontal:30,marginTop:15}}>
              <Text style={{fontSize:16,fontWeight:'bold',color:'black'}}>Start investing today to achieve your goal</Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                ...
                <View style={{marginHorizontal:20,borderRadius:12,backgroundColor:'#FFB6C1',padding:10}}>
                  <Text style={{color:'rgb(224, 32, 32)',fontWeight:'bold'}}>{last}</Text>
                </View>



                <View style={{flexDirection:'row',marginHorizontal:30,marginLeft:25,marginTop:40}}>
                           <View style={{width:'50%',marginRight:10}}>
                            ...
                            <Text style={{marginTop:12,textAlign:"center",fontWeight:"700",fontSize:14,color:"white"}}>Map an Existing Investment</Text>
