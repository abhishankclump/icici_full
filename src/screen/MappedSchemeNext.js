    ...
    return (
        ...
        <View> 
          ...
          />
               ...
               <Text style={{fontSize:16,marginTop:20,marginLeft:20}}>{sen}</Text>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                ...
                <View style={{marginHorizontal:20,borderRadius:12,borderWidth:1,borderColor:'#ff726f',backgroundColor:'#FFB6C1',padding:10}}>
