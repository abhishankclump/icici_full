  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
            ...
            source={require('../../assets/img/group19.png')}
          />
      ...
      <View style={{marginHorizontal:40,marginTop:20}}>
        <Text style={{fontSize:16,color:'black',fontWeight:'bold'}}>How much have you already saved for your holiday?</Text>
      </View>
      ...
      <View style={{marginHorizontal:30,flexDirection:'row',marginRight:20}}>
...
<View style={{width:50}}>
  {/* <CheckBox 
    // title="I have not saved anything so far"
...
{/* <Text style={{marginTop:18,marginRight:40}}>I have not saved anything so far</Text> */}
  <View style={{marginRight:50}}>
  <Text style={{marginTop:18}}>I have not saved anything so far</Text>
  </View>
     ...
     <View style={{flexDirection:'row',marginHorizontal:30,marginLeft:25,marginTop:20}}>
                           <View style={{width:'50%',marginRight:10}}>
                            ...
                            <TouchableOpacity  onPress={()=> navigation.navigate('HolidayPlannerSix')}
