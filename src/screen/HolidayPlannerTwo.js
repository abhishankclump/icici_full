  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
            ...
            source={require('../../assets/img/group166.png')}
          />
      ...
      <View style={{marginHorizontal:50,marginTop:20}}>
        <Text style={{fontSize:16,color:'black',fontWeight:'bold'}}>How much do you earn annually?</Text>
      </View>
     ...
     <View style={{flexDirection:'row',marginHorizontal:30,marginLeft:25,marginTop:20}}>
                           <View style={{width:'50%',marginRight:10}}>
                            ...
                            <TouchableOpacity  onPress={()=> navigation.navigate('HolidayPlannerThree')}
