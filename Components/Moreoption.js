...
const Moreoption = ({ visible, closeCallback, shareOptionCallback }) => {
    return (
        <Modal
            isVisible={visible}
            ...
            <KeyboardAvoidingView
                ...
                <ScrollView scrollEnabled={false} keyboardShouldPersistTaps="handled">
                    <View
                        ...
                        <View
                            style={{
                                height: 400, borderTopLeftRadius: 20,
                                borderTopRightRadius: 20
                            }}>
                            ...
                            <View style={styles.singlerow}>
                                <View style={styles.item}>
                                    ...
                                    <Text style={{fontWeight:'600' ,textAlign:'center' , marginTop:5, color:'black'}}>STP</Text>
                                </View>
                                <View style={styles.item}>
                                    <TouchableOpacity style={styles.singleicon}><MaterialCommunityIcons size={25} name='bank-outline' color="black" /></TouchableOpacity>
                                    <Text style={{fontWeight:'600' ,textAlign:'center' , marginTop:5, color:'black'}}>SWP</Text>
                                </View>
                                <View style={styles.item}>
                                    <TouchableOpacity style={styles.singleicon}><Switching size={25} name='arrow-swap' color="black" /></TouchableOpacity>
                                    <Text style={{fontWeight:'600' ,textAlign:'center' , marginTop:5, color:'black'}}>Switch</Text>
                                </View>
                                <View style={styles.item}>
                                    <TouchableOpacity style={styles.singleicon}><Share size={25} name='md-share-social-outline' color="black" /></TouchableOpacity>
                                    <Text style={{fontWeight:'600' ,textAlign:'center' , marginTop:5, color:'black'}}>Share</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.singlerow}>
                                ...
                                <View style={styles.item}>
                                    <TouchableOpacity style={styles.singleicon}><Moon size={25} name='moon' color="black" /></TouchableOpacity>
                                    <Text style={{fontWeight:'600' ,textAlign:'center' , marginTop:5, color:'black'}}>Mode</Text>
                                </View>
                                <View style={styles.item}>
                                    <TouchableOpacity style={styles.singleicon}><Iconic size={25} name='eye' color="black" /></TouchableOpacity>
                                    <Text style={{fontWeight:'600' ,textAlign:'center' , marginTop:5, color:'black'}}>withdrawal</Text>
                                </View>
                                <View style={styles.item}>
